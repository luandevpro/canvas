...
import {
  ...
  HusbleTextBox,
  HusbleRect,
  HusbleImagePlaceholder,
  MaskImagePlaceholder,
  DynamicImage,
  TextBox,
} from "./objects";
...
const CanvasObject: CanvasObjectSchema = {
  ...
  // },
  husbletextbox: {
    create: ({ src, ...option }: { src: string }) =>
      new HusbleTextBox(src, option),
  },
  husblerect: {
    create: ({ ...option }) => new HusbleRect(option),
  },
  husbleimageplaceholder: {
    create: ({ ...option }) => new HusbleImagePlaceholder(option),
  },
  dynamicimage: {
    create: ({ ...option }) => new DynamicImage(option),
  },
  maskimageplaceholder: {
    create: ({ ...option }) => new MaskImagePlaceholder(option),
  },
  TextBox: {
    create: ({ ...option }) =>
      new TextBox(option),
